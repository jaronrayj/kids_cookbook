...
function Cookies() {
    ...
    const steps = [
        ...
        },
        {
            ...
            img: 'https://img.icons8.com/cute-clipart/200/000000/sugar-cube.png',
            img2: threeQuarters,
            img3: 'https://img.icons8.com/ios/100/000000/c.png',
        },
        {
            ...
            num: 4,
            text: '1 t Vanilla',
            img: 'https://img.icons8.com/android/200/000000/water.png',
    ...
    return (
        ...
        <>
            ...
            < Header style={topBuffer} size='huge' > Cookies</Header>
            {steps.map((step) =>
                <RecipeStep
